...
const CreateProposal = () => {
  ...
  const uploadEventImage = () => {
    if (eventImage) {
      uploadImages(eventImage).then((res) => {
  ...
  const uploadImages = async (val) => {
    ...
    return axios
      .post("https://api.cloudinary.com/v1_1/db8cyhega/image/upload", data)
      .then((res) => {
        return res.data.url;
      });
  };
     ...
     <VendorHeader />
      <form className="proposalPostingForm">
        <header>
          ...
          <Clear
            className="proposalPostingFormbackSymbol"
            onClick={() => {
              navigate("/view");
            }}
          />
        ...
        <section>
          ...
          <section className="proposalPostingFormBodyRightPart">
            ...
            <section className="Images">
              <img
                id="renderEventImage"
                src={eveImg ? eveImg : "/images/render.jpg"}
                alt="eventImage"
              />
            </section>
            <section>
            ...
            <section className="Images">
              <img
                id="renderVenueImage0"
                className="renderImages"
                src={
                  venImg[0]
                    ? URL.createObjectURL(venImg[0])
                    : "/images/render.jpg"
                }
                alt="venueImage"
              />
              <img
                id="renderEventImage1"
                className="renderImages"
                src={
                  venImg[1]
                    ? URL.createObjectURL(venImg[1])
                    : "/images/render.jpg"
                }
                alt="venueImage"
              />
              <img
                id="renderEventImage2"
                className="renderImages"
                src={
                  venImg[2]
                    ? URL.createObjectURL(venImg[2])
                    : "/images/render.jpg"
                }
                alt="venueImage"
              />
              <img
                id="renderEventImage3"
                className="renderImages"
                src={
                  venImg[3]
                    ? URL.createObjectURL(venImg[3])
                    : "/images/render.jpg"
                }
                alt="venueImage"
              />
              <img
                id="renderEventImage4"
                className="renderImages"
                src={
                  venImg[4]
                    ? URL.createObjectURL(venImg[4])
                    : "/images/render.jpg"
                }
                alt="venueImage"
              />
