        ...
        axios
          ...
          .then((response) => {
            if (response.data.msg === "Success") {
              ...
              response.data.msg === "Unauthorized, Incorrect password"
            ) {
              Swal.fire({
                position: "center",
                icon: "error",
        ...
        <section>
          ...
          <section>
            <form className="signinPageForm">
              <section>
                <button
                  className={vendor ? "signinPageContainerButtonColor" : null}
                  onClick={dataBaseToggleHandler}
                >
                  vendor
                </button>
                <button
                  className={vendor ? null : "signinPageContainerButtonColor"}
                  onClick={dataBaseToggleHandler}
                >
                  User
                </button>
